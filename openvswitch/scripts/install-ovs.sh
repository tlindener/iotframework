...
apt-get update
apt-get install gcc autoconf automake openssl openssl-devel libtool make perl pkgconfig python python-simplejson supervisor wget -y
...
apt-get remove gcc autoconf automake openssl-devel libtool -y
